...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(10, 50, 284, 113));
        ...
        txt_idade = new QLineEdit(widget);
        txt_idade->setObjectName(QString::fromUtf8("txt_idade"));

        horizontalLayout_3->addWidget(txt_idade);
        ...
        horizontalLayout_4->addWidget(txt_peso);
        ...
        horizontalLayout_2->addWidget(btn_limpar);
