...
void MainWindow::on_pushButton_clicked()
{
    ...
    if(ui->radioButton_aviao->isChecked())          //está com 'autoexclusive' selecionada, em 'QabstractButton'
    {
        ntransp = 1;
    }
    else if(ui->radioButton_carro->isChecked())     //está com 'autoexclusive' selecionada, em 'QabstractButton'
    {
        ntransp = 2;
    }
    else if(ui->radioButton_navio->isChecked())      //está com 'autoexclusive' selecionada, em 'QabstractButton'
    {
        ntransp = 3;
    }
